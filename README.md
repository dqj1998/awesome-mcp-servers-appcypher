...
- <img src="https://cdn.simpleicons.org/rust/000000" height="14"/> [MCPOrb](https://github.com/dqj1998/MCPOrb) - Portable MCP Packager & Marketplace. Package docs, knowledge bases, and playbooks into self-contained, zero-trust MCP servers as single-file Orbs. Browse and publish at [mcporb.store](https://mcporb.store). Supports BM25, Vector, Hybrid search. Runs locally in Claude, Cursor, VS Code with zero data upload.
